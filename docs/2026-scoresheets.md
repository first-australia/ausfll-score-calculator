...
`FLL_CHALLENGE_FOUNDERS` · season 20262027 · **maximum 520 points**
...
| `m07b` | Is a connection formed between your extended mycelium and the opposing team's fully extended plant root? (not possible in remote competitions or with no opposing team) | Yes / No (default No) | 10 _(conditional)_ |

- **Scoring:** The connection bonus (10) requires your mycelium fully extended (m07a).
- **Validation error:** m07b set without m07a.
